 ...
 */
class CRM_Oddc_Upgrader_Base {

  /**
   * @var CRM_Oddc_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Oddc_Upgrader(
        'oddc',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Oddc_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Oddc_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
